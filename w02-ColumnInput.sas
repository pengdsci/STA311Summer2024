...
/*************************************************************
    ...
    Topics: Examples Illustrating the Following Concepts
      1. Program header;
      2. Display control;
      3. SAS library - file/folder structure;
      4. Data Step and Procedure Step;
      5. Commenting and documentation;
      6. Conventions and naming rules;
      7. Debugging code - understand SAS log;
      8. Find SAS dataset structure: descriptor and data block
***************************************************************/
...
*/
/* The COLUMN INPUT us used for this example. */
